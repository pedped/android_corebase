...
public class TimeAgo {
	...
	public String timeAgo(long MillisorSecound) {

		if (MillisorSecound < 9999999999l) {
			MillisorSecound = MillisorSecound * 1000;
		}

		long diff = new Date().getTime() - MillisorSecound;
